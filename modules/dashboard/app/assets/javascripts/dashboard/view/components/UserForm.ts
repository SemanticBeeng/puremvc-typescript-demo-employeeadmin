...
export class UserForm
     ...
     */
    private userRoles:roleVOReference.RoleVO[] = null;
    ...
    private fillList(deptEnumList:deptEnumReference.DeptEnum[]):void {
        ...
        for (var i:number = 0; i < deptEnumList.length; i++) {
            var deptEnum:deptEnumReference.DeptEnum = deptEnumList[i];
            ...
            if (!this.user && deptEnum.equals(deptEnumReference.DeptEnum.NONE_SELECTED))
                selectedAttr = "selected";
    ...
    updateUser():void {
        ...
        var deptEnumList:deptEnumReference.DeptEnum[] = deptEnumReference.DeptEnum.getComboList();
    ...
    private getErrors():boolean {
        ...
        var selected:number = parseInt(this.department.val()) + 1;
        var deptEnumList:deptEnumReference.DeptEnum[] = deptEnumReference.DeptEnum.getComboList();
        var department:deptEnumReference.DeptEnum = deptEnumList[selected];

        if (department.equals(deptEnumReference.DeptEnum.NONE_SELECTED))
